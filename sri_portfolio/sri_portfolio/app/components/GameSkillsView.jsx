    ...
    subcategories: [
      {
        ...
        skills: [
          ...
          { name: "Express.js", icon: <IconBrandExpress />, color: "yellow" },
          { name: "Java", icon: <IconBrandJava />, color: "red" },
          { name: ".NET", icon: <IconBrandMicrosoft />, color: "blue" },
        ],
      },
      {
        ...
        skills: [
          ...
          { name: "WebSockets", icon: <IconBrandWebsocket />, color: "purple" },
    ...
    subcategories: [
      {
        ...
        skills: [
          ...
          { name: "Linux/Unix", icon: <IconBrandLinux />, color: "yellow" },
          { name: "macOS", icon: <IconBrandApple />, color: "black" },
        ],
      },
      {
    ...
    subcategories: [
      {
        name: "Soft Skills",
        skills: [
          { name: "Communication", icon: <IconMessageCircle />, color: "blue" },
          { name: "Presentation", icon: <IconMic />, color: "orange" },
      ...
      },
      {
        ...
        skills: [
          { name: "Leadership", icon: <IconUser />, color: "purple" },
          { name: "Adaptability", icon: <IconRotateClockwise />, color: "teal" },
