  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed bottom-0 inset-x-0 p-2 sm:p-4 z-50 md:bottom-4 md:left-1/2 md:-translate-x-1/2 md:w-[90%] md:max-w-3xl"
      >
        <div className="bg-neutral-900/90 backdrop-blur-md shadow-lg rounded-xl border border-white/10 p-4 flex flex-col sm:flex-col md:flex-row items-center gap-4">
          {/* Close */}
          <button
