...
import { faLinkedinIn, faGithub, faInstagram, faDiscord, faSpotify, faRightFromBracket } from '@fortawesome/free-brands-svg-icons';
        ...
        <div className="home-container">
            <section className="home" id="home">
                ...
                <div className="home-img">
                    ...
                    <Link to="/aboutme" className="aboutmebutton">
